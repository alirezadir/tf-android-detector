...
public class TensorFlowYoloDetector implements Classifier {
  ...
  private static final boolean USE_COCO = true;

  private static final int NUM_CLASSES_VOC = 20;
  private static final int NUM_CLASSES_COCO = 80;
  private static final int NUM_CLASSES = USE_COCO ? NUM_CLASSES_COCO : NUM_CLASSES_VOC;

  private static final int NUM_BOXES_PER_BLOCK = 5;

  // TODO(andrewharp): allow loading anchors and classes
  // from files.
  private static final double[] ANCHORS_VOC = {
    1.08, 1.19,
    3.42, 4.41,
    6.63, 11.38,
    9.42, 5.11,
  ...
  // anchors from tiny-yolo.cfg
  private static final double[] ANCHORS_COCO = {
          0.738768,0.874946,
          2.42204,2.65704,
          4.30971,7.04493,
          10.246,4.59428,
  ...
  private static final double[] ANCHORS = USE_COCO ? ANCHORS_COCO : ANCHORS_VOC;
...
private static final String[] LABELS = USE_COCO ? LABELS_COCO : LABELS_VOC;
